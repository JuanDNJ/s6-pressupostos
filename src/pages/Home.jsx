      ...
      <article className="max-w-7xl m-auto flex flex-col gap-2 py-4">
        <div className="py-4">
          ...
          <p className="p-4 text-xl md:text-2xl text-center md:text-pretty">
            ...
            oferir serveis d'alta qualitat en SEO (Optimització de Motors de
            Recerca), ADS (Publicitat en Línia) i Disseny de Pàgines Web. El
            nostre enfocament es centra en comprendre les necessitats úniques de
            cada client i desenvolupar estratègies personalitzades per
          ...
          <ul className="flex flex-col md:flex-row gap-2">
            <li className="gap-2 flex flex-col items-center justify-around min-h-64">
              ...
              <p className="flex-1 p-4 text-xl text-center md:text-pretty">
                ...
                posicionament orgànic dels llocs web dels nostres clients en els
                motors de cerca més importants com Google, Bing i Yahoo.
                Realitzem anàlisis exhaustius de paraules clau, optimització de
                contingut, construcció de enllaços i altres tècniques avançades
                per augmentar el trànsit orgànic i la visibilitat en línia.
              </p>
            </li>
            ...
            <li className="flex flex-col items-center justify-around min-h-64">
              ...
              <p className="flex-1 p-4 text-xl text-center md:text-pretty">
                ...
                l'usuari. Ens assegurem que cada lloc web que desenvolupem sigui
                responsive, fàcil de navegar i estigui alineat amb la identitat
                de marca i els objectius comercials dels nostres clients.
              </p>
            </li>
          </ul>
        </div>
